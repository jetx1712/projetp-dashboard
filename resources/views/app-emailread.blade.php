								...
								<div class="email-form">
									...
									<div class="mb-0">
										<div class="d-flex align-items-center">
											...
											<div class="ms-2">
												<button type="button" class="btn border-0 btn-light"><i class="lni lni-text-format"></i>
												</button>
												<button type="button" class="btn border-0 btn-light"><i class='bx bx-link-alt'></i>
												</button>
												<button type="button" class="btn border-0 btn-light"><i class="lni lni-emoji-tounge"></i>
												</button>
												<button type="button" class="btn border-0 btn-light"><i class="lni lni-google-drive"></i>
												</button>
											</div>
											<div class="ms-auto">
												<button type="button" class="btn border-0 btn-light"><i class="lni lni-trash"></i>
												</button>
											</div>
										</div>
									</div>
